# BlumAuto
Follow This Installation Guide [https://t.me/GN_SCRIPTS]
...
Click the following url to register : [https://t.me/blum/app?startapp=ref_5nFz4GuA4k]
...
2. Clone this repository
   ```shell
   git clone https://github.com/NaimGazi0786/Blumauto.git
   ```
